...
(function () {
  ...
  System.register(['./index-legacy-Ddxasszj.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [function (module) {
        ...
        createEffect = module.a;
        on = module.o;
        setGlobalBackground = module.s;
        createComponent = module.b;
        Show = module.S;
        View = module.V;
        ContentBlock = module.C;
        Row = module.R;
        Button = module.B;
        Column = module.d;
        styles = module.e;
...
//# sourceMappingURL=entity-legacy-DPKQTJhc.js.map
